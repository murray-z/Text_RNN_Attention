...
class TextRnnAttention():
    def __init__(self, config):
        ...
        with tf.name_scope('attention'):
            attention_output, alphas = attention(outputs, self.attention_size, return_alphas=True)


        # add dropout
        with tf.name_scope('dropout'):
            self.rnn_drop = tf.nn.dropout(attention_output, self.dropout_keep_prob)
